...
def move_agent():
    try:
        ...
        if direction == 'up' and x > 0: new_pos[0] -= 1
        elif direction == 'down' and x < world.rows - 1: new_pos[0] += 1
        elif direction == 'left' and y > 0: new_pos[1] -= 1
        elif direction == 'right' and y < world.cols - 1: new_pos[1] += 1
        else: return jsonify({'error': 'Invalid move'}), 400
